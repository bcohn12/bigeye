...
formattedstring = [ ...
    ' The ' ...
    'finned tetrapods had orbits that were $' num2str(mean(TF_orbit_length_span(:,1)),2) ...
    ' \pm ' num2str(std(TF_orbit_length_span(:,1)),2) '$~mm long (all numbers mean $\pm$ standard deviation), ' ...
    'while the digited tetrapods had orbits that were ' num2str(mean(ST_orbit_length_span(:,1)),2) ...
    ...
    'colosteids ($N=' num2str(length(SecAqOrb)) '$), and the digited tetrapods with these taxa removed ($N=' ...
     num2str(length(noSecAqOrb)) '$). The mean orbit ' ...
     'length for the secondarily-aquatic digited tetrapods was ' ...
     num2str(mean(SecAqOrb),2) ...
    ' $\pm$ ' num2str(std(SecAqOrb),2) '~mm long, ' ...
    'while the length for the digited tetrapods without the colosteids was ' ...
    num2str(mean(noSecAqOrb),2) ...
    ' $\pm$ ' num2str(std(noSecAqOrb),2) '~mm. Similarly ' ...
    'the ratio of orbit length to skull length for the colosteids and ' ...
    'terrestrial digited tetrapods was ' ...
    num2str(mean([100.*(SecAqOrb./SecAqSkl)]),2) ...
    ' $\pm$ ' num2str(std([100.*(noSecAqOrb./noSecAqSkl)]),2) '\%, and ' ...
