...
%% AERIAL VISION MODEL
    ...
    daylightAerialParameters={'$\eta$';
        ...
        '$F$';
        '$\mathtt{L}$'};
    daylightAerialValues={num2str(qAerial_Daylight);...
        num2str(DtAerial_Daylight,'%.2f');...
        num2str(FAerial_Daylight);...
        num2str(BAerial_Daylight,'%10.1e')};
    ...
    moonlightAerialParameters={'$\eta$';
        ...
        '$F$';
        '$\mathtt{L}$'};
    moonlightAerialValues={num2str(qAerial_Moonlight);...
        num2str(DtAerial_Moonlight,'%.2f');...
        num2str(FAerial_Moonlight);...
        num2str(BAerial_Moonlight,'%10.1e')};
    ...
    starlightAerialParameters={'$\eta$';
        ...
        '$F$';
        '$\mathtt{L}$'};
    starlightAerialValues={num2str(qAerial_Starlight);...
        num2str(DtAerial_Starlight,'%.2f');...
        num2str(FAerial_Starlight);...
        num2str(BAerial_Starlight,'%10.1e')};
