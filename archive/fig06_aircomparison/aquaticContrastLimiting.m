function aquaticContrastLimiting
    ...
    for j=1:length(conditions)
        aString=strcat('a_',conditions{j}); bString=strcat('b_',conditions{j});
        KdString=strcat('Kd_',conditions{j}); KhString=strcat('Kh_',conditions{j});
        %LdString=strcat('Ld_',conditions{i}); LhString=strcat('Lh_',conditions{i});
        BdString=strcat('Bd_',conditions{j}); BhString=strcat('Bh_',conditions{j});
        C0String=strcat('C0_',conditions{j});
    ...
    save('actualRiver','actRange_River','pupilValues')
