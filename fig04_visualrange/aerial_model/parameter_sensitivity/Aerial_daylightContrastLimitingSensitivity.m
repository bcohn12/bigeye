function [actRangeDaylight] =Aerial_daylightContrastLimitingSensitivity
global BIGEYEROOT
%EVERYTHING IN THIS FUNCTION SHOULD USE THE FIELD .Daylight
    ...
    for i=1:length(pupilValuesAir);
        ...
        if (10^(Kt_daylight(i))*1.15) <= abs(Cr_daylight(i))
            ...
            while((10^(Kt_daylight(i)))*1.15 > abs(Cr_daylight(i)))
    ...
    save([BIGEYEROOT 'fig03_visualrange/aerial_model/parameter_sensitivity/visibilityAerialContrastSensitivity_Daylight.mat'], 'visualRangeDaylight','pupilValuesAir');
