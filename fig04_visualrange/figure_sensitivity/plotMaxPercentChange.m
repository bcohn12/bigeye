...
% Aquatic Derivative Range wrt Pupil Diameter
    ...
    fillboxErr=fill([pupilValues'*1e3;flipud(pupilValues')*1e3],...
        [mindrdA.AqUp;flipud(drdA_River(:,1))],...
        [0 0.4470 0.7410],'linestyle','none');
    alpha(fillboxErr,0.35)
...
% Aquatic Volume
    ...
    fillboxErr=fill([pupilValues'*1e3;flipud(pupilValues')*1e3],...
        [minVisualVolume.AqUp/1e2;flipud(maxVisualVolume.AqUp/1e2)],...
        [0 0.4470 0.7410],'linestyle','none');
    alpha(fillboxErr,0.35)
...
% Aquatic Derivative Volume wrt Pupil Diameter
    ...
    fillboxErr=fill([pupilValues'*1e3;flipud(pupilValues')*1e3],...
        [mindVdA.AqUp/10;flipud(dVdA_River(:,1))/10],...
        [0 0.4470 0.7410],'linestyle','none');
    alpha(fillboxErr,0.35)
...
% Aerial Range
    ...
    fillboxErr=fill([pupilValuesAir'*1e3;flipud(pupilValuesAir')*1e3],...
...
% Aerial Derivative Range wrt Pupil Diameter
    ...
    fillboxErr=fill([pupilValuesAir'*1e3;flipud(pupilValuesAir')*1e3],...
        [smooth(mindrdA.ArHor/1e2);flipud(smooth(maxdrdA.ArHor))/1e2],...
        [0 0.4470 0.7410],'linestyle','none');
    alpha(fillboxErr,0.35)
...
% Aerial Volume
    ...
    fillboxErr=fill([pupilValuesAir'*1e3;flipud(pupilValuesAir')*1e3],...
        [minVisualVolume.ArHor/1e8;flipud(maxVisualVolume.ArHor)/1e8],...
        [0 0.4470 0.7410],'linestyle','none');
    alpha(fillboxErr,0.35)
...
% Aerial Derivative Volume wrt Pupil Diameter
    ...
    fillboxErr=fill([pupilValuesAir'*1e3;flipud(pupilValuesAir')*1e3],...
        [mindVdA.ArHor/1e7;flipud(maxdVdA.ArHor)/1e7],...
        [0 0.4470 0.7410],'linestyle','none');
    alpha(fillboxErr,0.35)
